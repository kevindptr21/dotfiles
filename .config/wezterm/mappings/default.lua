...
local mappings = {
  -- my map
  { "<W-S-]>", act.ActivateTabRelative(1), "next tab" },
  { "<W-S-[>", act.ActivateTabRelative(-1), "prev tab" },
  { "<W-t>", act.SpawnTab "CurrentPaneDomain", "new tab" },
  { "<W-w>", act.CloseCurrentTab { confirm = true }, "close tab" },
